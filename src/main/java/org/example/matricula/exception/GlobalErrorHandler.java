...
import org.example.matricula.dto.GenericResponse;
...
public class GlobalErrorHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<CustomErrorResponse> handleModelDefaultException(Exception ex, WebRequest req) {
        CustomErrorResponse errorResponse = new CustomErrorResponse(LocalDate.now(), ex.getMessage(), req.getDescription(false));
